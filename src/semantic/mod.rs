...
pub(crate) fn is_cached(schema: u64, model: Option<&str>) -> bool {
...
pub(crate) fn warm(records: &[SchemaRecord], model: Option<&str>, refresh: bool) -> usize {
